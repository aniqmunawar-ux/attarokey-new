...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="${sheetName}">
  ...
  const filteredSantri = santriList.filter((s) => {
    ...
    return matchesSearch && matchesStatus && matchesGender && matchesDomisili;
  });
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchQuery, statusFilter, genderFilter, domisiliFilter]);
                ...
                <>
                  ...
                  <span 
                    onClick={() => {
                      ...
                      setGenderFilter(allowedGenders[nextIndex]);
                    }}
